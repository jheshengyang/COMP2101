...
test -f ~/public_html/pics/pics.tgz || (wget -q -O ~/public_html/pics/pics.tgz http://zonzorp.net/pics.tgz && tar -xzf ~/public_html/pics/pics.tgz -C ~/public_html/pics && rm ~/public_html/pics/pics.tgz)
# Task 1: Improve this script to also retrieve and install the files kept in the https://zonzorp.net/pics.tgz tarfile
