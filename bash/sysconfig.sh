...
OPTION:
  -h or --help
        display this help and exist
  --host
        only display host name
  --domain
        only display NIS/YP domain name
  --ipconfig
        only display this machine's IP info and all network interfaces
  --os
        only display this machine's OS name and version
  --cpu
        only display this machine's hardware information
  --memory
        only display this machine's memories information
  --disk
        only display this machine's disk usage information
  --printer
